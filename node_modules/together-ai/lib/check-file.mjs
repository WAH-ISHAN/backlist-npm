import { createReadStream, readline, isUtf8, resolve, stat, extname, readFile } from "./node-unsafe-imports.mjs";
// Constants
const MIN_SAMPLES = 1;
...
export async function checkFile(file, purpose = 'fine-tune') {
...
export function validate_messages(messages, idx, require_assistant_role = true) {
...
export function validate_preference_openai(example, idx = 0) {
...
//# sourceMappingURL=check-file.mjs.map