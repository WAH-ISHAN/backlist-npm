...
import { checkFile } from "./check-file.mjs";
import { createReadStream, stat, extname } from "./node-unsafe-imports.mjs";
import { APIPromise } from "../core/api-promise.mjs";
const failedUploadMessage = {
    message: 'failed to upload file',
};
const baseURL = readEnv('TOGETHER_API_BASE_URL') || 'https://api.together.xyz/v1';
export function upload(client, fileName, purpose, check = true) {
