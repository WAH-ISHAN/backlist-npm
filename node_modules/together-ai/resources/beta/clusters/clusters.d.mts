...
import * as StorageAPI from "./storage.mjs";
import { ClusterStorage, Storage, StorageCreateParams, StorageDeleteResponse, StorageListResponse, StorageUpdateParams } from "./storage.mjs";
...
export declare namespace ClusterListRegionsResponse {
    interface Region {
        /**
...
export declare namespace Clusters {
    export { type Cluster as Cluster, type ClusterListResponse as ClusterListResponse, type ClusterDeleteResponse as ClusterDeleteResponse, type ClusterListRegionsResponse as ClusterListRegionsResponse, type ClusterCreateParams as ClusterCreateParams, type ClusterUpdateParams as ClusterUpdateParams, };
    export { Storage as Storage, type ClusterStorage as ClusterStorage, type StorageListResponse as StorageListResponse, type StorageDeleteResponse as StorageDeleteResponse, type StorageCreateParams as StorageCreateParams, type StorageUpdateParams as StorageUpdateParams, };
}
