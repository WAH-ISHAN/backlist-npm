...
import * as FineTuningAPI from "./fine-tuning.mjs";
...
export declare namespace FinetuneResponse {
...
export declare namespace FineTuningCreateResponse {
    /**
     * Learning rate scheduler configuration
     */
    interface LrScheduler {
...
export declare namespace FineTuningListResponse {
    /**
     * A truncated version of the fine-tune response, used for POST /fine-tunes, GET
     * /fine-tunes and POST /fine-tunes/{id}/cancel endpoints
     */
...
export declare namespace FineTuningCancelResponse {
    /**
     * Learning rate scheduler configuration
     */
    interface LrScheduler {
...
export declare namespace FineTuningListCheckpointsResponse {
    interface Data {
...
export declare namespace FineTuningCreateParams {
    /**
     * The learning rate scheduler to use. It specifies how the learning rate is
     * adjusted during training.
     */
...
export declare namespace FineTuningEstimatePriceParams {
    interface TrainingMethodSft {
        method: 'sft';
        /**
         * Whether to mask the user messages in conversational data or prompts in
