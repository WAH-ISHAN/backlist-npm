...
export declare namespace EvaluationJob {
    interface EvaluationClassifyResults {
        /**
    ...
    interface EvaluationScoreResults {
    ...
    namespace EvaluationScoreResults {
    ...
    interface EvaluationCompareResults {
        /**
...
export declare namespace EvalStatusResponse {
    interface EvaluationClassifyResults {
        /**
         * Number of failed generations.
         */
...
export declare namespace EvalCreateParams {
    interface EvaluationClassifyParameters {
        /**
         * Data file ID
         */
    ...
    namespace EvaluationClassifyParameters {
        interface Judge {
            /**
        ...
        interface EvaluationModelRequest {
            /**
    ...
    interface EvaluationScoreParameters {
        /**
         * Data file ID
         */
        input_data_file_path: string;
    ...
    namespace EvaluationScoreParameters {
        interface Judge {
            /**
             * Name of the judge model
             */
    ...
    interface EvaluationCompareParameters {
        /**
         * Data file name
         */
        input_data_file_path: string;
    ...
    namespace EvaluationCompareParameters {
        interface Judge {
            /**
             * Name of the judge model
             */
...
export declare namespace Evals {
    export { type EvaluationJob as EvaluationJob, type EvalCreateResponse as EvalCreateResponse, type EvalListResponse as EvalListResponse, type EvalStatusResponse as EvalStatusResponse, type EvalCreateParams as EvalCreateParams, type EvalListParams as EvalListParams, };
}
