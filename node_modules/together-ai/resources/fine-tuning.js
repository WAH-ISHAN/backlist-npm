...
class FineTuning extends resource_1.APIResource {
     ...
     */
    retrieve(id, options) {
        return this._client.get((0, path_1.path) `/fine-tunes/${id}`, options);
    }
    /**
    ...
    delete(id, params = {}, options) {
        const { force } = params ?? {};
        return this._client.delete((0, path_1.path) `/fine-tunes/${id}`, { query: { force }, ...options });
    }
    /**
     ...
     */
    cancel(id, options) {
        return this._client.post((0, path_1.path) `/fine-tunes/${id}/cancel`, options);
    }
    /**
    ...
    listCheckpoints(id, options) {
        return this._client.get((0, path_1.path) `/fine-tunes/${id}/checkpoints`, options);
    }
    /**
    ...
    listEvents(id, options) {
        return this._client.get((0, path_1.path) `/fine-tunes/${id}/events`, options);
    }
}
