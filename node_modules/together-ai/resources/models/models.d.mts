...
import { UploadStatusResponse, Uploads } from "./uploads.mjs";
...
export declare namespace ModelObject {
    interface Pricing {
        base: number;
        finetune: number;
        hourly: number;
...
export declare namespace Models {
    export { type ModelObject as ModelObject, type ModelListResponse as ModelListResponse, type ModelUploadResponse as ModelUploadResponse, type ModelListParams as ModelListParams, type ModelUploadParams as ModelUploadParams, };
