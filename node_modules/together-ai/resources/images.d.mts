...
export declare class Images extends APIResource {
     ...
     * ```
     */
    generate<Body extends ImageGenerateParams>(body: Body, options?: RequestOptions): APIPromise<Omit<ImageFile, 'data'> & {
...
export declare namespace Images {
    export { type ImageDataB64 as ImageDataB64, type ImageDataURL as ImageDataURL, type ImageFile as ImageFile, type ImageGenerateParams as ImageGenerateParams, };
}
