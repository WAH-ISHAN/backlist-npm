...
class Endpoints extends resource_1.APIResource {
    ...
    retrieve(endpointID, options) {
        return this._client.get((0, path_1.path) `/endpoints/${endpointID}`, options);
    }
    /**
    ...
    update(endpointID, body, options) {
        return this._client.patch((0, path_1.path) `/endpoints/${endpointID}`, { body, ...options });
    }
    /**
    ...
    delete(endpointID, options) {
        return this._client.delete((0, path_1.path) `/endpoints/${endpointID}`, {
            ...options,
