...
var _Together_instances, _a, _Together_encoder, _Together_baseURLOverridden;
...
const evals_1 = require("./resources/evals.js");
const files_1 = require("./resources/files.js");
const fine_tuning_1 = require("./resources/fine-tuning.js");
const images_1 = require("./resources/images.js");
const rerank_1 = require("./resources/rerank.js");
...
class Together {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('TOGETHER_BASE_URL'), apiKey = (0, env_1.readEnv)('TOGETHER_API_KEY'), ...opts } = {}) {
        ...
        this.rerank = new API.Rerank(this);
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('TOGETHER_LOG'), "process.env['TOGETHER_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Together_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Together_instances, "m", _Together_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Together_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Together = Together;
_a = Together, _Together_encoder = new WeakMap(), _Together_instances = new WeakSet(), _Together_baseURLOverridden = function _Together_baseURLOverridden() {
