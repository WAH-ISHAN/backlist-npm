...
import { Evals, } from "./resources/evals.mjs";
import { Files } from "./resources/files.mjs";
import { FineTuning, } from "./resources/fine-tuning.mjs";
import { Images } from "./resources/images.mjs";
import { Rerank } from "./resources/rerank.mjs";
...
import { Models, } from "./resources/models/models.mjs";
...
export class Together {
    ...
    constructor({ baseURL = readEnv('TOGETHER_BASE_URL'), apiKey = readEnv('TOGETHER_API_KEY'), ...opts } = {}) {
        ...
        __classPrivateFieldSet(this, _Together_encoder, Opts.FallbackEncoder, "f");
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!__classPrivateFieldGet(this, _Together_instances, "m", _Together_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
